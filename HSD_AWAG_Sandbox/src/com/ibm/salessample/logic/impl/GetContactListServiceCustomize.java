...
/**
* GetContactList サービスのカスタマイズクラス
*
*/ 
@Interceptors(MethodTraceLoggingInterceptor.class)
@Stateless
public class GetContactListServiceCustomize extends GetContactListService implements ServiceIF<GetContactListInputDTO, GetContactListOutputDTO> {

	/* (非 Javadoc)
	 * @see com.ibm.jp.awag2.common.logic.ServiceIF#execute(com.ibm.jp.awag2.common.dto.DTOBase)
	 */
	public GetContactListOutputDTO execute(GetContactListInputDTO input) throws ServiceDBException, ServiceAppException {
	 ...
	 *
	@Override
	protected GetContactListOutputDTO execute(GetContactListInputDTO input) throws ServiceDBException, ServiceAppException {
		return super.execute(input);
	}

	@Override
	protected Map<String, Object> processInput(GetContactListInputDTO input) throws ServiceDBException, ServiceAppException {
