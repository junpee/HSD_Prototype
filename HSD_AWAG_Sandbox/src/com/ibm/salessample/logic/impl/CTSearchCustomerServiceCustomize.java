...
/**
* CTSearchCustomer サービスのカスタマイズクラス
*
*/ 
@Interceptors(MethodTraceLoggingInterceptor.class)
@Stateless
public class CTSearchCustomerServiceCustomize extends CTSearchCustomerService implements ServiceIF<CTSearchCustomerInputDTO, CTSearchCustomerOutputDTO> {

	/* (非 Javadoc)
	 * @see com.ibm.jp.awag2.common.logic.ServiceIF#execute(com.ibm.jp.awag2.common.dto.DTOBase)
	 */
	public CTSearchCustomerOutputDTO execute(CTSearchCustomerInputDTO input) throws ServiceDBException, ServiceAppException {
	 ...
	 *
	@Override
	protected CTSearchCustomerOutputDTO execute(CTSearchCustomerInputDTO input) throws ServiceDBException, ServiceAppException {
		return super.execute(input);
	}

	@Override
	protected Map<String, Object> processInput(CTSearchCustomerInputDTO input) throws ServiceDBException, ServiceAppException {
