...
/**
* GetCustomer サービスのカスタマイズクラス
*
*/ 
@Interceptors(MethodTraceLoggingInterceptor.class)
@Stateless
public class GetCustomerServiceCustomize extends GetCustomerService implements ServiceIF<GetCustomerInputDTO, GetCustomerOutputDTO> {

	/* (非 Javadoc)
	 * @see com.ibm.jp.awag2.common.logic.ServiceIF#execute(com.ibm.jp.awag2.common.dto.DTOBase)
	 */
	public GetCustomerOutputDTO execute(GetCustomerInputDTO input) throws ServiceDBException, ServiceAppException {
	 ...
	 *
	@Override
	protected GetCustomerOutputDTO execute(GetCustomerInputDTO input) throws ServiceDBException, ServiceAppException {
		return super.execute(input);
	}

	@Override
	protected Map<String, Object> processInput(GetCustomerInputDTO input) throws ServiceDBException, ServiceAppException {
