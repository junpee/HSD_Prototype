...
/**
* UpdateContact サービスのカスタマイズクラス
*
*/ 
@Interceptors(MethodTraceLoggingInterceptor.class)
@Stateless
public class UpdateContactServiceCustomize extends UpdateContactService implements ServiceIF<UpdateContactInputDTO, UpdateContactOutputDTO> {

	/* (非 Javadoc)
	 * @see com.ibm.jp.awag2.common.logic.ServiceIF#execute(com.ibm.jp.awag2.common.dto.DTOBase)
	 */
	public UpdateContactOutputDTO execute(UpdateContactInputDTO input) throws ServiceDBException, ServiceAppException {
	 ...
	 *
	@Override
	protected UpdateContactOutputDTO execute(UpdateContactInputDTO input) throws ServiceDBException, ServiceAppException {
		return super.execute(input);
	}

	@Override
	protected Map<String, Object> processInput(UpdateContactInputDTO input) throws ServiceDBException, ServiceAppException {
