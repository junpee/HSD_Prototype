...
/**
* GetContact サービスのカスタマイズクラス
*
*/ 
@Interceptors(MethodTraceLoggingInterceptor.class)
@Stateless
public class GetContactServiceCustomize extends GetContactService implements ServiceIF<GetContactInputDTO, GetContactOutputDTO> {

	/* (非 Javadoc)
	 * @see com.ibm.jp.awag2.common.logic.ServiceIF#execute(com.ibm.jp.awag2.common.dto.DTOBase)
	 */
	public GetContactOutputDTO execute(GetContactInputDTO input) throws ServiceDBException, ServiceAppException {
	 ...
	 *
	@Override
	protected GetContactOutputDTO execute(GetContactInputDTO input) throws ServiceDBException, ServiceAppException {
		return super.execute(input);
	}

	@Override
	protected Map<String, Object> processInput(GetContactInputDTO input) throws ServiceDBException, ServiceAppException {
