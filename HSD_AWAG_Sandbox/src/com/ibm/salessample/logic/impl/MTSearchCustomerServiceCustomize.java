...
/**
* MTSearchCustomer サービスのカスタマイズクラス
*
*/ 
@Interceptors(MethodTraceLoggingInterceptor.class)
@Stateless
public class MTSearchCustomerServiceCustomize extends MTSearchCustomerService implements ServiceIF<MTSearchCustomerInputDTO, MTSearchCustomerOutputDTO> {

	/* (非 Javadoc)
	 * @see com.ibm.jp.awag2.common.logic.ServiceIF#execute(com.ibm.jp.awag2.common.dto.DTOBase)
	 */
	public MTSearchCustomerOutputDTO execute(MTSearchCustomerInputDTO input) throws ServiceDBException, ServiceAppException {
	 ...
	 *
	@Override
	protected MTSearchCustomerOutputDTO execute(MTSearchCustomerInputDTO input) throws ServiceDBException, ServiceAppException {
		return super.execute(input);
	}

	@Override
	protected Map<String, Object> processInput(MTSearchCustomerInputDTO input) throws ServiceDBException, ServiceAppException {
