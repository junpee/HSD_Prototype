...
/**
* DeleteContact サービスのカスタマイズクラス
*
*/ 
@Interceptors(MethodTraceLoggingInterceptor.class)
@Stateless
public class DeleteContactServiceCustomize extends DeleteContactService implements ServiceIF<DeleteContactInputDTO, DeleteContactOutputDTO> {

	/* (非 Javadoc)
	 * @see com.ibm.jp.awag2.common.logic.ServiceIF#execute(com.ibm.jp.awag2.common.dto.DTOBase)
	 */
	public DeleteContactOutputDTO execute(DeleteContactInputDTO input) throws ServiceDBException, ServiceAppException {
	 ...
	 *
	@Override
	protected DeleteContactOutputDTO execute(DeleteContactInputDTO input) throws ServiceDBException, ServiceAppException {
		return super.execute(input);
	}

	@Override
	protected Map<String, Object> processInput(DeleteContactInputDTO input) throws ServiceDBException, ServiceAppException {
