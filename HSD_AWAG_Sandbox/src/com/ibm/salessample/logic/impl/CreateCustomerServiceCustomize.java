...
/**
* CreateCustomer サービスのカスタマイズクラス
*
*/ 
@Interceptors(MethodTraceLoggingInterceptor.class)
@Stateless
public class CreateCustomerServiceCustomize extends CreateCustomerService implements ServiceIF<CreateCustomerInputDTO, CreateCustomerOutputDTO> {

	/* (非 Javadoc)
	 * @see com.ibm.jp.awag2.common.logic.ServiceIF#execute(com.ibm.jp.awag2.common.dto.DTOBase)
	 */
	public CreateCustomerOutputDTO execute(CreateCustomerInputDTO input) throws ServiceDBException, ServiceAppException {
	 ...
	 *
	@Override
	protected CreateCustomerOutputDTO execute(CreateCustomerInputDTO input) throws ServiceDBException, ServiceAppException {
		return super.execute(input);
	}

	@Override
	protected Map<String, Object> processInput(CreateCustomerInputDTO input) throws ServiceDBException, ServiceAppException {
