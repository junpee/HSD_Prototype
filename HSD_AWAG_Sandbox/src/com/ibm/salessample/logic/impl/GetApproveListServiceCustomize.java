...
/**
* GetApproveList サービスのカスタマイズクラス
*
*/ 
@Interceptors(MethodTraceLoggingInterceptor.class)
@Stateless
public class GetApproveListServiceCustomize extends GetApproveListService implements ServiceIF<GetApproveListInputDTO, GetApproveListOutputDTO> {

	/* (非 Javadoc)
	 * @see com.ibm.jp.awag2.common.logic.ServiceIF#execute(com.ibm.jp.awag2.common.dto.DTOBase)
	 */
	public GetApproveListOutputDTO execute(GetApproveListInputDTO input) throws ServiceDBException, ServiceAppException {
	 ...
	 *
	@Override
	protected GetApproveListOutputDTO execute(GetApproveListInputDTO input) throws ServiceDBException, ServiceAppException {
		return super.execute(input);
	}

	@Override
	protected Map<String, Object> processInput(GetApproveListInputDTO input) throws ServiceDBException, ServiceAppException {
