...
/**
* UpdateCustomer サービスのカスタマイズクラス
*
*/ 
@Interceptors(MethodTraceLoggingInterceptor.class)
@Stateless
public class UpdateCustomerServiceCustomize extends UpdateCustomerService implements ServiceIF<UpdateCustomerInputDTO, UpdateCustomerOutputDTO> {

	/* (非 Javadoc)
	 * @see com.ibm.jp.awag2.common.logic.ServiceIF#execute(com.ibm.jp.awag2.common.dto.DTOBase)
	 */
	public UpdateCustomerOutputDTO execute(UpdateCustomerInputDTO input) throws ServiceDBException, ServiceAppException {
	 ...
	 *
	@Override
	protected UpdateCustomerOutputDTO execute(UpdateCustomerInputDTO input) throws ServiceDBException, ServiceAppException {
		return super.execute(input);
	}

	@Override
	protected Map<String, Object> processInput(UpdateCustomerInputDTO input) throws ServiceDBException, ServiceAppException {
