...
/**
* コンタクト履歴取得 リソースクラス（GetContact）
*
*/ 
 @Interceptors(MethodTraceLoggingInterceptor.class)
@Dependent
public class GetContactResource {

	/** コンタクト履歴取得 Service（GetContact） */
	@Inject
	private ServiceIF<GetContactInputDTO, GetContactOutputDTO> service;

	public Response execute(GetContactInputDTO input) throws ServiceDBException, ServiceAppException {
		
		// CUSTOMIZE: ビジネスロジック前処理を実装
		
		GetContactOutputDTO result = service.execute(input);
