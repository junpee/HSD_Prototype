...
public class CreateCustomerResource {
	...
	/** お客様作成 Service（CreateCustomer） */
	@Inject
	private ServiceIF<CreateCustomerInputDTO, CreateCustomerOutputDTO> service;

	public Response execute(CreateCustomerInputDTO input) throws ServiceDBException, ServiceAppException {
		
		// CUSTOMIZE: ビジネスロジック前処理を実装
		
		CreateCustomerOutputDTO result = service.execute(input);
