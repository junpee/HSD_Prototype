...
import com.ibm.salessample.resource.impl.CreateCustomerResource;
 
/**
* お客様作成 リソース・マネージャクラス（CreateCustomer）
* お客様作成
*/ 
@Path("/customer")
public class CreateCustomerResourceManager extends ResourceManagerBase {
	
	@Inject 
	private CreateCustomerResource createcustomerResource;
	
	@POST
	@Consumes({ MediaType.APPLICATION_JSON, MediaType.TEXT_XML })
	@Produces({ MediaType.APPLICATION_JSON, MediaType.TEXT_XML })
	public Response execute(CreateCustomerInputDTO input) throws ServiceDBException, ServiceAppException, ValidationException {
		
		// 単項目入力チェック
		super.validateBean(input);
		
		Response response = createcustomerResource.execute(input);
