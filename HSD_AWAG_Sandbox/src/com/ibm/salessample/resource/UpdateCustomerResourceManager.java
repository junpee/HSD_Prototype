...
import com.ibm.salessample.resource.impl.UpdateCustomerResource;
 
/**
* お客様更新 リソース・マネージャクラス（UpdateCustomer）
* お客様更新
*/ 
@Path("/customer")
public class UpdateCustomerResourceManager extends ResourceManagerBase {
	
	@Inject 
	private UpdateCustomerResource updatecustomerResource;
	
	@PUT
	@Consumes({ MediaType.APPLICATION_JSON, MediaType.TEXT_XML })
	@Produces({ MediaType.APPLICATION_JSON, MediaType.TEXT_XML })
	public Response execute(UpdateCustomerInputDTO input) throws ServiceDBException, ServiceAppException, ValidationException {
		
		// 単項目入力チェック
		super.validateBean(input);
		
		Response response = updatecustomerResource.execute(input);
