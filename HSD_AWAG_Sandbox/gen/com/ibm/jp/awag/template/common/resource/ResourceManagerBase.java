...
import com.ibm.jp.awag.rest.common.logic.ValidationErrorInfo;
		...
		if (!validateResult.isEmpty()) {
			...
			for (ConstraintViolation<T> cv : validateResult) {
				...
				if (fieldName != null && !fieldName.isEmpty()) {
					...
					if(annotationClazz.equals(com.ibm.jp.awag.rest.common.validator.StringFormat.class)) {
						code = "_EVDS0001";
					} else if (annotationClazz.equals(com.ibm.jp.awag.rest.common.validator.Number.class)) {
						code = "_EVDN0001";
					} else if (annotationClazz.equals(com.ibm.jp.awag.rest.common.validator.DateTime.class)) {
						code = "_EVDD0001";
					}

					// エラーメッセージの構築
					String message =  "[" + displayKey + "]" + displayFieldName +  " " + cv.getMessage();
